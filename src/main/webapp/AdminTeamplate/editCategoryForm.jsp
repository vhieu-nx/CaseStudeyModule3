            ...
            <form action="/admin-categories" method="get">
                <div class="card card-block">
                    <div class="form-group row" hidden>
                        <label class="col-sm-2 form-control-label text-xs-right"> ID Category: </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control boxed" name="category_id" value="${category.category_id}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label text-xs-right"> Name: </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control boxed" name="category_name" value="${category.name}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10 col-sm-offset-2">
                            <button type="submit" class="btn btn-primary" value="update" name="action"> Submit</button>
                        </div>
                    </div>
                </div>
            </form>
