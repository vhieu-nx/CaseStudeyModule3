            ...
            <form name="item">
                <div class="card card-block">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="content" class="form-control boxed" placeholder=""></div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <select class="c-select form-control boxed" name="categories">
                                <c:forEach var="movies" items="${listMovie}">
                                <option selected>Select Category</option>
                                <option value="${movies.category_id}">${movies.name}</option>
                                </c:forEach>
                            </select>
