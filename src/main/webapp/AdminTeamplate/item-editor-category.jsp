    ...
    <div class="app" id="app">
        ...
        <article class="content item-editor-page">
            <div class="title-block">
                <h3 class="title"> Add New Item Category
                    <span class="sparkline bar" data-type="bar"></span>
                </h3>
            </div>
            <form action="admin-categories" name="item" method="post">
                <div class="card card-block">

                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label text-xs-right"> Name Category: </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control boxed" name="name" placeholder="Enter Name Category"></div>
                    </div>
                    <div class="form-group row">
