...
<head>
    ...
    <script src="<c:url value='/AdminTeamplate/js/jquery.twbsPagination.js'/>"></script>
    <script>
    ...
    <div class="app" id="app">
        ...
        <article class="content items-list-page">
         ...
         -->
                        ...
                        <li class="item">
                            <div class="item-row">
                                ...
                                <div class="item-col fixed item-col-img md">
                                    <a>
                                        <div class="item-img rounded"
                                             style="background-image: url(${rv.image_movie})"></div>
                                    </a>
                                </div>
                                <div class="item-col fixed pull-left item-col-title">
                                    ...
                                    <div>
                                        <a class="">
                                            <h4 class="item-title"> ${rv.title} </h4>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="item-actions-dropdown">
                                        ...
                                        <div class="item-actions-block">
                                            <ul class="item-actions-list">
                                                <li>
                                                    <a href="MovieServlet?action=delete&id=${rv.movie_id}"
                                                       title="Delete Film">
                                                ...
                                                <li>
                                                    <a href="MovieServlet?action=edit&id=${rv.movie_id}"
                                                       title="Edit Film">
            ...
            <form action="<c:url value='/MovieServlet'/>" id="formSubmit" method="get">
...
<script>
    let totalPages = ${listMovie.totalPage};
