                ...
                <ul class="nav navbar-nav flex-child-menu menu-left">
                    ...
                    <li class="dropdown first">
                        <a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown">
                            ${movies.title} <i class="fa fa-angle-down" aria-hidden="true"></i>
                        </a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="slick-multiItemSlider">
                <c:forEach var="item" items="${movies.listResult}">
                    <div class="movie-item">
                        ...
                        <div class="title-in">
                            <div class="cate">
                                <span class="blue"><a href="#">${item.title}</a></span>
                            </div>
                            <h6><a href="#">${item.content}</a></h6>
                            ...
                            <div class="row">
                                <div class="blog-item-style-1">
                                    ...
                                    <div class="blog-it-infor">
                                        <h3><a href="#">Brie Larson to play first female white house candidate Victoria
                                            Woodull in Amazon film</a></h3>
                ...
                <div class="sidebar">
                    ...
                    <div class="sb-twitter sb-it">
                        ...
                        <div class="slick-tw">
                            ...
                            <div class="tweet item" id="form"><!-- Put your 2nd twiter account id here -->
                            </div>
                        </div>
                    </div>
                </div>
