                                                    ...
                                                    <ul class="notifications-container">
                                                        <li>
                                                            <a href="#" class="notification-item">
                                                                ...
                                                                <div class="body-col">
                                                                    <p>
                                                                        <span class="accent">Zack Alien</span> pushed
                                                                        new commit:
                                                        ...
                                                        <li>
                                                            <a href="#" class="notification-item">
                                                                ...
                                                                <div class="body-col">
                                                                    <p>
                                                                        <span class="accent">Andy Nouman</span> deployed
                                                                        new version of
                                            ...
                                            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="sidebar-nav">
                                                        ...
                                                        <li>
                                                            <a href="AdminTeamplate/error-404-alt.jsp"> Error 404
                                                                Global </a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a href="AdminTeamplate/error-500-alt.jsp"> Error 500
                                                                Global </a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                    ...
                                                    <li class="customize">
                                                        ...
                                                        <div class="customize-item">
                                                            <ul class="customize-colors">
                                                                <li>
                                                                    <span class="color-item color-red"
                                                                          data-theme="red"></span>
                                                                </li>
                                                                <li>
                                                                    <span class="color-item color-orange"
                                                                          data-theme="orange"></span>
                                                                </li>
                                                                <li>
                                                                    <span class="color-item color-green active"
                                                                          data-theme=""></span>
                                                                </li>
                                                                <li>
                                                                    <span class="color-item color-seagreen"
                                                                          data-theme="seagreen"></span>
                                                                </li>
                                                                <li>
                                                                    <span class="color-item color-blue"
                                                                          data-theme="blue"></span>
                                                                </li>
                                                                <li>
                                                                    <span class="color-item color-purple"
                                                    ...
                                                    <div class="card-block">
                                                        <div class="tab-content">
                                                            <div role="tabpanel" class="tab-pane active fade show"
                                                                 id="visits">
                                                                <p class="title-description"> Number of unique visits
                                                                    last 30 days </p>
                                                                <div id="dashboard-visits-chart"></div>
                                                            </div>
                                                            <div role="tabpanel" class="tab-pane fade" id="downloads">
                                                                <p class="title-description"> Number of downloads last
                                                                    30 days </p>
                                                ...
                                                <div class="card sameheight-item items" data-exclude="xs,sm,lg">
                                                    <div class="card-header bordered">
                                                        <div class="header-block">
                                                            ...
                                                            <a href="AdminTeamplate/item-editor.jsp"
                                                        ...
                                                        <li class="item">
                                                            <div class="item-row">
                                                                ...
                                                                <div class="item-col item-col-title no-overflow">
                                                                    <div>
                                                                        <a href="#" class="">
                                                                            <h4 class="item-title no-wrap"> 12 Myths
                                                                                Uncovered About IT &amp; Software </h4>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="item-col item-col-stats">
                                                                    ...
                                                                    <div class="no-overflow">
                                                                        <div class="item-stats sparkline"
                                                                             data-type="bar"></div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="item">
                                                            <div class="item-row">
                                                                ...
                                                                <div class="item-col item-col-title no-overflow">
                                                                    <div>
                                                                        <a href="#" class="">
                                                                            <h4 class="item-title no-wrap"> 50% of
                                                                                things doesn&#x27;t really belongs to
                                                                                you </h4>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="item">
                                                            <div class="item-row">
                                                                ...
                                                                <div class="item-col item-col-title no-overflow">
                                                                    <div>
                                                                        <a href="#" class="">
                                                                            <h4 class="item-title no-wrap"> Vestibulum
                                                                                tincidunt amet laoreet mauris sit sem
                                                        ...
                                                        <li class="item">
                                                            <div class="item-row">
                                                                <div class="item-col fixed item-col-img xs">
                                                                    <a href="#">
                                                                        <div class="item-img xs rounded"
                                                                             style="background-image: url(../../s3.amazonaws.com/uifaces/faces/twitter/why_this/128.jpg)"></div>
                                                                    </a>
                                                                </div>
                                                                <div class="item-col item-col-title no-overflow">
                                                                    <div>
                                                                        <a href="#" class="">
                                                                            <h4 class="item-title no-wrap"> 10 tips of
                                                        ...
                                                        <li class="item">
                                                            <div class="item-row">
                                                                <div class="item-col fixed item-col-img xs">
                                                                    <a href="#">
                                                                        <div class="item-img xs rounded"
                                                                             style="background-image: url(../../s3.amazonaws.com/uifaces/faces/twitter/w7download/128.jpg)"></div>
                                                                    </a>
                                                                </div>
                                                                <div class="item-col item-col-title no-overflow">
                                                                    <div>
                                                                        <a href="#" class="">
                                                                            <h4 class="item-title no-wrap"> Sometimes
                                                                                friend tells it is cold </h4>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="item-col item-col-sales">
                                                        ...
                                                        <li class="item">
                                                            <div class="item-row">
                                                                <div class="item-col fixed item-col-img xs">
                                                                    <a href="#">
                                                                        <div class="item-img xs rounded"
                                                                             style="background-image: url(../../s3.amazonaws.com/uifaces/faces/twitter/pankogut/128.jpg)"></div>
                                                                    </a>
                                                                </div>
                                                                <div class="item-col item-col-title no-overflow">
                                                                    <div>
                                                                        <a href="#" class="">
                                                                            <h4 class="item-title no-wrap"> New ways of
                                                                                conceptual thinking </h4>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="item-col item-col-sales">
                                            ...
                                            <div class="col-md-4">
                                                <div class="card tasks sameheight-item" data-exclude="xs,sm">
                                                    <div class="card-header bordered">
                                                        ...
                                                        <div class="header-block pull-right">
                                                            <a href="#"
                                                               class="btn btn-primary btn-sm rounded pull-right"> Add
                                                                new </a>
                                                        </div>
                                                    </div>
                                                    <div class="card-block">
                                ...
                                <footer class="footer">
                                    ...
                                    <div class="footer-block author">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="https://github.com/modularcode/modular-admin-html#get-in-touch">get
                                                    in touch</a>
                                            </li>
                                        </ul>
                                    </div>
                                                            ...
                                                            <div id="dropzone">
                                                                <form action="https://modularcode.io/" method="POST"
                                                                    ...
                                                                    <div class="dz-message-block">
                                                                        <div class="dz-message needsclick"> Drop files
